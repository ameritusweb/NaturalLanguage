    ...
    public class OrbOfTime
    {
        public void Write()
        {
            Scene orbOfTimeMission = new Scene
            {
                ...
                ActionThatContributesToSafety = new StoryWord { WordText = "Creating Temporal Bubbles" },
                ...
                AnActionThatContributesToSafety = new StoryWord { WordText = "Establishing Safe Havens in Time" },
